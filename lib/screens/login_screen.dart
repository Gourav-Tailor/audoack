  ...
  Future<void> login() async {
    ...
    try {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (_) => DevicesScreen(username: username, apiService: widget.apiService),
        ),
      );
    } catch (_) {
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  const Text('AudoAck', textAlign: TextAlign.center,
                      style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  const Text('Audio Analysis Dashboard', textAlign: TextAlign.center,
